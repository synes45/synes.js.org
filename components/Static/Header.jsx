        ...
        <>
            <div className={"pb-10 w-full flex items-center justify-between"}>
                <div className="flex items-center space-x-2">
                    <Link href="/">
                        <a className="pr-1 text-white font-bold text-4xl">SyneS</a>
                    </Link>
                    <a target="_blank" href="https://discord.gg/HbfQuZE4nP" className="flex items-center justify-center cursor-pointer social w-10 h-10 rounded-lg">
